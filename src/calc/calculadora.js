...
var nutriPresentes = [3.1, 4.7, 2.3, 1.22, 0.30, 1.5]
...
export const cafe = () => {
    ...
    let rank = Math.abs(parseFloat(NFal)) + Math.abs(parseFloat(PFal)) + Math.abs(parseFloat(KFal)) + Math.abs(parseFloat(CaFal)) + Math.abs(parseFloat(MgFal)) + Math.abs(parseFloat(SFal))
